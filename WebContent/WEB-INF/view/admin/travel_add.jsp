			...
			<form action="/admin/travel_add" method="post"
				...
				<div>
					...
					<br /> <input type="text" name="contact" id="contact"
						pattern="^\d{2,3}-\d{3,4}-\d{4}$" /><br /> <span id="howto"
						style="color: red; display: none">번호만 입력가능하며, 번호 사이에
						하이픈(-)을 꼭 넣어주세요.</span>
				</div>
				<div>
					<b>설명</b><br />
					<textarea name="detail" id="detail"
						onkeyup='maxLengthCheck("detail", "설명")'></textarea>
...
<script>
	...
	function maxLengthCheck(id, title) {
		var obj = $("#" + id);
		var maxLength = obj.attr("maxLength") != null ? obj.attr("maxLength")
				: 1000;
