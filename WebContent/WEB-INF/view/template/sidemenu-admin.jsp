...
<ul class="nav nav-pills nav-stacked">
	<li class="dropdown"><a class="dropdown-toggle"
		...
		<ul class="dropdown-menu">
			...
			<li><a href="/admin/station/insert">기차역 추가하기</a></li>
			<li><a href="/admin/station/manage">기차역 조회 및 수정</a></li>
			<li class="dropdown-header">- 여행지 관리하기 -</li>
			<li><a href="/admin/travel/insert">여행지 추가하기</a></li>
			<li><a href="/admin/travel/manage">여행지 조회 및 수정</a></li>
		</ul></li>
